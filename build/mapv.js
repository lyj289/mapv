    ...
    createClass(BaseLayer, [{
        ...
        value: function isPointInPath(context, pixel) {
            ...
            if (this.dataSet._rt) {
                ...
                var width = 3;
                var lbPixel = new BMap.Pixel(pixel.x - width, pixel.y - width);
                var rtPixel = new BMap.Pixel(pixel.x + width, pixel.y + width);
                var lbPoint = this.map.pixelToPoint(lbPixel);
                var rtPoint = this.map.pixelToPoint(rtPixel);
